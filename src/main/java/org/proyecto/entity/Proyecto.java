...
public class Proyecto {
    ...
    private Date fechaModiificacion;
    ...
    public Date getFechaModiificacion() {
        return fechaModiificacion;
    }

    public void setFechaModiificacion(Date fechaModiificacion) {
        this.fechaModiificacion = fechaModiificacion;
    }
